...
def test_restart_state_roundtrip_restores_runtime_state(tmp_path):
    ...
    state = build_training_restart_state(
        ...
        current_model_path=hydra_output_dir / "model.pt",
        current_optimizer_path=hydra_output_dir / "optimizer.pt",
        best_model_path=hydra_output_dir / "model_phase_2.pt",
        best_optimizer_path=hydra_output_dir / "optimizer_phase_2.pt",
